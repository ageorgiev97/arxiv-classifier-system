...
class SciBertClassifier(ArxivClassifierBase):
    def __init__(self, num_classes, model_name="giacomomiolo/scibert_reupload", dropout_rate=0.1, **kwargs):
        ...
        # Papers typically have 1-3 labels out of 50, so we want low initial predictions
